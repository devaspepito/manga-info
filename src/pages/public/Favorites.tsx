...
export function Favorites() {
  ...
  const [favoriteMangas, setFavoriteMangas] = useState<MangaInfoDTO[]>([]);

  useEffect(() => {
    // TODO: Cargar mangas favoritos desde el backend
    const savedFavorites = localStorage.getItem("favoriteMangas");
    if (savedFavorites) {
      setFavoriteMangas(JSON.parse(savedFavorites));
    }
  }, []);
      ...
      >
        ...
        {favoriteMangas.length === 0 ? (
          ...
          >
            ...
            >
              No tienes mangas favoritos aún
            </Typography>
          </Box>
        ) : (
          <Box
